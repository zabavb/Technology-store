...
namespace Library.Models
{
    public class User
    {
        ...
        public User(long id, string username, string? firstName, string? lastName, int? age, string email, string phone, string password, string? role, List<Product> basket, List<Product> purchases)
        {
            Id = id;
            Username = username;
            FirstName = firstName;
